-- serial_id on thoughts is BIGINT, not INTEGER. Fix the function return type
-- so PostgREST stops returning "structure of query does not match" at runtime.
...
RETURNS TABLE (
  thought_a_id UUID,
  thought_b_id UUID,
  thought_a_serial BIGINT,
  thought_b_serial BIGINT,
  content_a TEXT,
  content_b TEXT,
