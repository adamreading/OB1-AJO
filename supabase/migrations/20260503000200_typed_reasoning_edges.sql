...
--      supersedes, depends_on, related_to, derived_from). This is distinct from the
...
--      derived_from — Generated/synthesized thought is derived from a source thought
--
...
CREATE TABLE IF NOT EXISTS public.thought_edges (
  ...
  relation TEXT NOT NULL CHECK (
    relation IN ('supports', 'contradicts', 'evolved_into', 'supersedes', 'depends_on', 'related_to', 'derived_from')
  ),
